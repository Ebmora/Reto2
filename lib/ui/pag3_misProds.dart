...
class _pag3_misproductosState extends State<pag3_misproductos> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Container(child: Column(
      children: [
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              ListTile(
                ...
                subtitle: Text("Precio : "+Control.pro[index].precio.toString()+ ' | '+"Cantidad : "+Control.pro[index].cantidad.toString()),
        ...
        Divider(),
        Text('Total a pagar : '+Control.calcularTotal().toString(), style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
        Divider(),
        ElevatedButton.icon(onPressed: (){

          Alert(
          type: AlertType.success,
          context: context, title: 'ATENCIÓN!!', 
          desc: 'Compra realizada de manera exitosa',
          buttons: [
            DialogButton(child: Text("CERRAR"), onPressed: (){
              Control.limpiartodo();
        ...
        icon: Icon(Icons.shopping_basket), label: Text("Comprar"))
